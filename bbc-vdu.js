...
class BeebVDU {
  constructor(params){
    ...
    this.textCursor         = [0,0];
    this.graphicsForeground = 0xff00ff00;
    this.textForeground     = 0xff000000;
    this.textBackground     = 0x00000000;
    this.paletteLUT         = new Uint32Array(32);
  ...
  gcol(i,j){
    let red   = (j & 1) ? 0x000000ff : 0;
    let green = (j & 2) ? 0x0000ff00 : 0;
    let blue  = (j & 4) ? 0x00ff0000 : 0;
    this.graphicsForeground = 0xff000000 | red | green | blue;
  }
