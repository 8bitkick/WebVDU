...
class BeebVDU {
  constructor(params){
    ...
    this.graphicsCursor     = new Uint16Array(8);
    this.graphicsCursorPtr  = 0;
    this.textCursor         = [0,0];
    this.graphicsForeground = 1;
    this.textForeground     = 0xff000000;
    this.textBackground     = 0x00000000;
    this.paletteLUT         = new Uint32Array(256);
      this.paletteLUT[0] = 0xFF000000;
      this.paletteLUT[1] = 0xFFFFFFFF;
  ...
  _pushGraphicsCursor(x,y){
    ...
    this.graphicsCursorPtr = (this.graphicsCursorPtr+2) & 0x7;
    this.graphicsCursor[this.graphicsCursorPtr] = x;
    this.graphicsCursor[this.graphicsCursorPtr+1] = y;
  }
  ...
  point(x,y){
    this._pushGraphicsCursor(x,y);
    let n = this.graphicsCursorPtr;
    this._pixel(this.graphicsCursor[n],this.graphicsCursor[n+1],this.graphicsForeground)
  }
}
